...
const tools: Tool[] = [
  ...
  { href: "/ferramentas/frases", title: "Banco de Frases", desc: "+2.000 frases prontas para copiar. Organizadas por 16 categorias: motivação, zueira, amor, futebol e mais.", emoji: "📖", category: "redes" },
